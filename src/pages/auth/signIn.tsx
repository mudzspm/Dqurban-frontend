...
{/* 
      <div
        ...
        // }}
      > */}
        <img src='Desktop.svg' alt='Desktop' className='w-[0%] md:w-full mt-[90px] md:mt-0' />
      ...
      <div className='m-auto md:absolute top-0 lg:ml-32 lg:mt-48 absolute lg:w-[456px] md:w-[379px] md:mt-0 mt-[4rem] py-10 md:py-0 mr-[30px] ml-[24px] bg-[#f8f7f7] rounded-sm md:bg-transparent'>
        ...
        <p className='lg:mt-4 text-4xl w-[92%] lg:w-full text-[#1A1A1A] font-semibold m-auto justify-center text-center mt-2 ml-1 lg:m-0'>Log Masuk</p>
        <div></div>
        <p className='lg:mt-[1.938rem] text-xs font-normal ml-[5%]'>E-mel</p>
         {/* <img src='Frame 1000004559.svg' alt='Frame 1000004559' className='absolute right-0 md:mr-[42px] mr-[28px] mt-4 ' /> */}
        <input
          name='email'
        ...
        <div className='mt-7 md:mt-3 ml-[6%]'>
        ...
        <div className='mt-7 md:mt-4 text-center'>
          ...
          <p className='lg:mt-16 md:mt-1 mt-12 text-xs text-[#0e0d0d]'>© DigitalQurban2024</p>
        </div>
      </div>
