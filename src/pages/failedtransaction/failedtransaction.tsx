...
const Failedtransaction = () => {
  ...
  <div className="mx-auto max-w-md overflow-hidden rounded-3xl text-gray-700 shadow-md">
    ...
    <div className="flex flex-col items-center bg-white px-4 py-10">
      <h2 className="mb-2 text-3xl font-bold text-[#2E6A7E] sm:text-4xl">Your transaction is failed. please try again!</h2>
      
      <Link to="/">
      <div className="flex items-center rounded-xl bg-[#2E6A7E] p-4 mt-6">
